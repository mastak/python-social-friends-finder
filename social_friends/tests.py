...
from social_friends.models import SocialFriendsList
...
class SocialFriendsManagerTest(TestCase):
    ...
    def test_fetch_friends_from_twitter(self):
        ...
        friend_ids = SocialFriendsList.objects.fetch_social_friend_ids(usa)
    ...
    def test_existing_social_friend_on_website(self):
        ...
        """
        usa = UserSocialAuth.objects.all()[0]
        friends = SocialFriendsList.objects.existing_social_friends(usa)
    ...
    def test_create_with_social_auth(self):
        usa = UserSocialAuth.objects.all()[0]
        social_friend = SocialFriendsList.objects.get_or_create_with_social_auth(usa)
