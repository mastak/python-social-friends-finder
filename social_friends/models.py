...
from social_friends.utils import SocialFriendsFinderBackendFactory
...
class SocialFriendsManager(models.Manager):
    ...
    def get_or_create_with_social_auth(self, social_auth):
        ...
        try:
            ...
            social_friend_list = SocialFriendsList()
...
class SocialFriendsList(models.Model):

    user_social_auth = models.OneToOneField(UserSocialAuth, related_name="social_friends")
    friends_ids = models.CommaSeparatedIntegerField(max_length=1000000, blank=True, help_text="friends ids seperated by commas")
    ...
    def existing_social_friends(self):
        return SocialFriendsList.objects.existing_social_friends(self.user_social_auth, self.friends_ids)
